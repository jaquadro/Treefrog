...
namespace Treefrog.Controls.Xna
{
    ...
    public class GraphicsDeviceControl : HwndHost
    {
        ...
        void XnaWindowHost_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            if (graphicsService == null && hWnd != null)
            {
        ...
        private void HandleDeviceReset ()
        {
            ...
            switch (graphicsService.GraphicsDevice.GraphicsDeviceStatus) {
                case GraphicsDeviceStatus.NotReset:
                    graphicsService.ResetDevice((int)ActualWidth, (int)ActualHeight);
                    break;

                default:
                    PresentationParameters pp = graphicsService.GraphicsDevice.PresentationParameters;
